...
void copyout(char *s) {
  ...
  for (int ai = 0; ai < 2; ai++) {
     ...
     760:	ba450513          	addi	a0,a0,-1116 # 6300 <malloc+0x30e>
     ...
     77e:	ba650513          	addi	a0,a0,-1114 # 6320 <malloc+0x32e>
     ...
     7b2:	ba250513          	addi	a0,a0,-1118 # 6350 <malloc+0x35e>
     ...
     7d0:	b9c50513          	addi	a0,a0,-1124 # 6368 <malloc+0x376>
...
void truncate1(char *s) {
  ...
  write(fd1, "abcdef", 6);
     ...
     8c0:	b3c58593          	addi	a1,a1,-1220 # 63f8 <malloc+0x406>
     8c4:	854e                	mv	a0,s3
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     946:	a5650513          	addi	a0,a0,-1450 # 6398 <malloc+0x3a6>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     962:	a5a50513          	addi	a0,a0,-1446 # 63b8 <malloc+0x3c6>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     976:	a5650513          	addi	a0,a0,-1450 # 63c8 <malloc+0x3d6>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     992:	a5a50513          	addi	a0,a0,-1446 # 63e8 <malloc+0x3f6>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a6:	a2650513          	addi	a0,a0,-1498 # 63c8 <malloc+0x3d6>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c4:	a4050513          	addi	a0,a0,-1472 # 6400 <malloc+0x40e>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e2:	a4250513          	addi	a0,a0,-1470 # 6420 <malloc+0x42e>
...
void writetest(char *s) {
  ...
  fd = open("small", O_CREATE | O_RDWR);
     ...
     a16:	a2e50513          	addi	a0,a0,-1490 # 6440 <malloc+0x44e>
  ...
  if (fd < 0) {
    ...
    if (write(fd, "aaaaaaaaaa", SZ) != SZ) {
     ...
     a2e:	a3e98993          	addi	s3,s3,-1474 # 6468 <malloc+0x476>
    if (write(fd, "bbbbbbbbbb", SZ) != SZ) {
     a32:	00006a97          	auipc	s5,0x6
     a36:	a6ea8a93          	addi	s5,s5,-1426 # 64a0 <malloc+0x4ae>
  for (i = 0; i < N; i++) {
  ...
  fd = open("small", O_RDONLY);
     ...
     a7c:	9c850513          	addi	a0,a0,-1592 # 6440 <malloc+0x44e>
  ...
  if (unlink("small") < 0) {
     ...
     ab8:	98c50513          	addi	a0,a0,-1652 # 6440 <malloc+0x44e>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae2:	96a50513          	addi	a0,a0,-1686 # 6448 <malloc+0x456>
    ...
    exit(1);
     ...
     b00:	97c50513          	addi	a0,a0,-1668 # 6478 <malloc+0x486>
     ...
     b1e:	99650513          	addi	a0,a0,-1642 # 64b0 <malloc+0x4be>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3a:	9a250513          	addi	a0,a0,-1630 # 64d8 <malloc+0x4e6>
    ...
    printf("%s: read failed\n", s);
     ...
     b56:	9a650513          	addi	a0,a0,-1626 # 64f8 <malloc+0x506>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b72:	9a250513          	addi	a0,a0,-1630 # 6510 <malloc+0x51e>
...
void writebig(char *s) {
  ...
  fd = open("big", O_CREATE | O_RDWR);
     ...
     ba4:	99050513          	addi	a0,a0,-1648 # 6530 <malloc+0x53e>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf6:	93e50513          	addi	a0,a0,-1730 # 6530 <malloc+0x53e>
  ...
  if (fd < 0) {
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c3e:	8fe50513          	addi	a0,a0,-1794 # 6538 <malloc+0x546>
    ...
    exit(1);
     ...
     c5c:	90050513          	addi	a0,a0,-1792 # 6558 <malloc+0x566>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c78:	90c50513          	addi	a0,a0,-1780 # 6580 <malloc+0x58e>
  ...
  if (unlink("big") < 0) {
     ...
     ca4:	89050513          	addi	a0,a0,-1904 # 6530 <malloc+0x53e>
     ...
     cd0:	8d450513          	addi	a0,a0,-1836 # 65a0 <malloc+0x5ae>
     ...
     cee:	8de50513          	addi	a0,a0,-1826 # 65c8 <malloc+0x5d6>
     ...
     d0c:	8d850513          	addi	a0,a0,-1832 # 65e0 <malloc+0x5ee>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d28:	8e450513          	addi	a0,a0,-1820 # 6608 <malloc+0x616>
...
void unlinkread(char *s) {
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d56:	8ce50513          	addi	a0,a0,-1842 # 6620 <malloc+0x62e>
  ...
  write(fd, "hello", SZ);
     ...
     d6e:	8e658593          	addi	a1,a1,-1818 # 6650 <malloc+0x65e>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8a:	89a50513          	addi	a0,a0,-1894 # 6620 <malloc+0x62e>
  ...
  if (unlink("unlinkread") != 0) {
     ...
     da0:	88450513          	addi	a0,a0,-1916 # 6620 <malloc+0x62e>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db6:	86e50513          	addi	a0,a0,-1938 # 6620 <malloc+0x62e>
  ...
  write(fd1, "yyy", 3);
     ...
     dca:	8d258593          	addi	a1,a1,-1838 # 6698 <malloc+0x6a6>
  ...
  unlink("unlinkread");
     ...
     e32:	7f250513          	addi	a0,a0,2034 # 6620 <malloc+0x62e>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e52:	7e250513          	addi	a0,a0,2018 # 6630 <malloc+0x63e>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e6e:	7ee50513          	addi	a0,a0,2030 # 6658 <malloc+0x666>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8a:	7f250513          	addi	a0,a0,2034 # 6678 <malloc+0x686>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea6:	7fe50513          	addi	a0,a0,2046 # 66a0 <malloc+0x6ae>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec2:	80250513          	addi	a0,a0,-2046 # 66c0 <malloc+0x6ce>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ede:	80650513          	addi	a0,a0,-2042 # 66e0 <malloc+0x6ee>
...
void linktest(char *s) {
  ...
  if (write(fd, "hello", SZ) != SZ) {
     ...
     f42:	71258593          	addi	a1,a1,1810 # 6650 <malloc+0x65e>
  ...
  if (link("lf1", "lf2") < 0) {
     ...
     f62:	7aa58593          	addi	a1,a1,1962 # 6708 <malloc+0x716>
     f66:	00005517          	auipc	a0,0x5
     f6a:	79a50513          	addi	a0,a0,1946 # 6700 <malloc+0x70e>
  ...
  unlink("lf1");
     ...
     f7e:	78650513          	addi	a0,a0,1926 # 6700 <malloc+0x70e>
     f82:	00005097          	auipc	ra,0x5
     f86:	c8e080e7          	jalr	-882(ra) # 5c10 <unlink>
  if (open("lf1", 0) >= 0) {
     f8a:	4581                	li	a1,0
     f8c:	00005517          	auipc	a0,0x5
     f90:	77450513          	addi	a0,a0,1908 # 6700 <malloc+0x70e>
  ...
  fd = open("lf2", 0);
     ...
     fa6:	76650513          	addi	a0,a0,1894 # 6708 <malloc+0x716>
  ...
  if (link("lf2", "lf2") >= 0) {
     ...
     fde:	72e58593          	addi	a1,a1,1838 # 6708 <malloc+0x716>
     fe2:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff4:	71850513          	addi	a0,a0,1816 # 6708 <malloc+0x716>
     ff8:	00005097          	auipc	ra,0x5
     ffc:	c18080e7          	jalr	-1000(ra) # 5c10 <unlink>
  if (link("lf2", "lf1") >= 0) {
    1000:	00005597          	auipc	a1,0x5
    1004:	70058593          	addi	a1,a1,1792 # 6700 <malloc+0x70e>
    1008:	00005517          	auipc	a0,0x5
    100c:	70050513          	addi	a0,a0,1792 # 6708 <malloc+0x716>
  ...
  if (link(".", "lf1") >= 0) {
    ...
    1020:	6e458593          	addi	a1,a1,1764 # 6700 <malloc+0x70e>
    1024:	00005517          	auipc	a0,0x5
    1028:	7ec50513          	addi	a0,a0,2028 # 6810 <malloc+0x81e>
    ...
    104a:	6ca50513          	addi	a0,a0,1738 # 6710 <malloc+0x71e>
    ...
    1066:	6c650513          	addi	a0,a0,1734 # 6728 <malloc+0x736>
    ...
    1082:	6c250513          	addi	a0,a0,1730 # 6740 <malloc+0x74e>
    ...
    109e:	6c650513          	addi	a0,a0,1734 # 6760 <malloc+0x76e>
    ...
    10ba:	6da50513          	addi	a0,a0,1754 # 6790 <malloc+0x79e>
    ...
    10d6:	6d650513          	addi	a0,a0,1750 # 67a8 <malloc+0x7b6>
    ...
    10f2:	6d250513          	addi	a0,a0,1746 # 67c0 <malloc+0x7ce>
    ...
    110e:	6de50513          	addi	a0,a0,1758 # 67e8 <malloc+0x7f6>
    ...
    112a:	6f250513          	addi	a0,a0,1778 # 6818 <malloc+0x826>
...
void validatetest(char *s) {
  ...
  for (p = 0; p <= (uint)hi; p += PGSIZE) {
    ...
    115c:	6e098993          	addi	s3,s3,1760 # 6838 <malloc+0x846>
    1160:	597d                	li	s2,-1
  for (p = 0; p <= (uint)hi; p += PGSIZE) {
  ...
  for (p = 0; p <= (uint)hi; p += PGSIZE) {
    ...
    1198:	6b450513          	addi	a0,a0,1716 # 6848 <malloc+0x856>
...
void bigdir(char *s) {
  ...
  for (i = 0; i < N; i++) {
    ...
    11fe:	66ea0a13          	addi	s4,s4,1646 # 6868 <malloc+0x876>
  for (i = 0; i < N; i++) {
  ...
  unlink("bd");
    ...
    1250:	61c50513          	addi	a0,a0,1564 # 6868 <malloc+0x876>
  ...
  for (i = 0; i < N; i++) {
    ...
    12c0:	5b450513          	addi	a0,a0,1460 # 6870 <malloc+0x87e>
    ...
    12e0:	5b450513          	addi	a0,a0,1460 # 6890 <malloc+0x89e>
    ...
    12fc:	5b850513          	addi	a0,a0,1464 # 68b0 <malloc+0x8be>
...
void copyinstr2(char *s) {
  ...
  char *args[] = {"xx", 0};
    ...
    13f2:	71a78793          	addi	a5,a5,1818 # 7b08 <malloc+0x1b16>
  ...
  if (pid == 0) {
    ...
    144e:	0fe78793          	addi	a5,a5,254 # 8548 <malloc+0x2556>
    ...
    148a:	4d250513          	addi	a0,a0,1234 # 6958 <malloc+0x966>
    ...
    14aa:	42a50513          	addi	a0,a0,1066 # 68d0 <malloc+0x8de>
    ...
    14ca:	42a50513          	addi	a0,a0,1066 # 68f0 <malloc+0x8fe>
    ...
    14ec:	42850513          	addi	a0,a0,1064 # 6910 <malloc+0x91e>
    ...
    150c:	43050513          	addi	a0,a0,1072 # 6938 <malloc+0x946>
    ...
    1526:	89650513          	addi	a0,a0,-1898 # 6db8 <malloc+0xdc6>
  ...
  if (st != 747) {
    ...
    1570:	41450513          	addi	a0,a0,1044 # 6980 <malloc+0x98e>
...
void truncate3(char *s) {
  ...
  if (pid == 0) {
    ...
    15d4:	410a8a93          	addi	s5,s5,1040 # 69e0 <malloc+0x9ee>
      int fd = open("truncfile", O_WRONLY);
    15d8:	4585                	li	a1,1
    15da:	8552                	mv	a0,s4
    ...
    1644:	37050513          	addi	a0,a0,880 # 69b0 <malloc+0x9be>
    ...
    1660:	36c50513          	addi	a0,a0,876 # 69c8 <malloc+0x9d6>
    ...
    167e:	37650513          	addi	a0,a0,886 # 69f0 <malloc+0x9fe>
    ...
    16a4:	370a8a93          	addi	s5,s5,880 # 6a10 <malloc+0xa1e>
    int fd = open("truncfile", O_CREATE | O_WRONLY | O_TRUNC);
  ...
  exit(xstatus);
    ...
    170c:	2c050513          	addi	a0,a0,704 # 69c8 <malloc+0x9d6>
    ...
    172a:	2f250513          	addi	a0,a0,754 # 6a18 <malloc+0xa26>
...
void exectest(char *s) {
  ...
  char *echoargv[] = {"echo", "OK", 0};
    ...
    175e:	2de78793          	addi	a5,a5,734 # 6a38 <malloc+0xa46>
    1762:	fcf43423          	sd	a5,-56(s0)
    1766:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176a:	00005517          	auipc	a0,0x5
    176e:	2d650513          	addi	a0,a0,726 # 6a40 <malloc+0xa4e>
  ...
  if (pid == 0) {
    ...
    179c:	2a850513          	addi	a0,a0,680 # 6a40 <malloc+0xa4e>
    ...
    17b8:	2ac50513          	addi	a0,a0,684 # 6a60 <malloc+0xa6e>
    ...
    17d4:	1e050513          	addi	a0,a0,480 # 69b0 <malloc+0x9be>
    ...
    17f0:	25c50513          	addi	a0,a0,604 # 6a48 <malloc+0xa56>
  ...
  if (xstatus != 0) exit(xstatus);
    ...
    1842:	23250513          	addi	a0,a0,562 # 6a70 <malloc+0xa7e>
    ...
    185e:	22e50513          	addi	a0,a0,558 # 6a88 <malloc+0xa96>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1872:	1d250513          	addi	a0,a0,466 # 6a40 <malloc+0xa4e>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189c:	c6050513          	addi	a0,a0,-928 # 64f8 <malloc+0x506>
    ...
    18b8:	11450513          	addi	a0,a0,276 # 69c8 <malloc+0x9d6>
  ...
  unlink("echo-ok");
    ...
    18d2:	17250513          	addi	a0,a0,370 # 6a40 <malloc+0xa4e>
  ...
  if (buf[0] == 'O' && buf[1] == 'K')
    ...
    18fc:	1a850513          	addi	a0,a0,424 # 6aa0 <malloc+0xaae>
...
void pipe1(char *s) {
  ...
  if (pid == 0) {
    ...
    19bc:	10050513          	addi	a0,a0,256 # 6ab8 <malloc+0xac6>
...
void pipe1(char *s) {
    ...
    1a42:	09250513          	addi	a0,a0,146 # 6ad0 <malloc+0xade>
    ...
    1a5e:	08e50513          	addi	a0,a0,142 # 6ae8 <malloc+0xaf6>
    ...
    1a90:	07450513          	addi	a0,a0,116 # 6b00 <malloc+0xb0e>
    ...
    1ad0:	05450513          	addi	a0,a0,84 # 6b20 <malloc+0xb2e>
...
void exitwait(char *s) {
  ...
  for (i = 0; i < 100; i++) {
    ...
    1b42:	e7250513          	addi	a0,a0,-398 # 69b0 <malloc+0x9be>
    ...
    1b5e:	fde50513          	addi	a0,a0,-34 # 6b38 <malloc+0xb46>
    ...
    1b7a:	fda50513          	addi	a0,a0,-38 # 6b50 <malloc+0xb5e>
...
void twochildren(char *s) {
  ...
  for (int i = 0; i < 1000; i++) {
    ...
    1bf2:	dc250513          	addi	a0,a0,-574 # 69b0 <malloc+0x9be>
    ...
    1c16:	d9e50513          	addi	a0,a0,-610 # 69b0 <malloc+0x9be>
...
void forkfork(char *s) {
    ...
    1c90:	ee450513          	addi	a0,a0,-284 # 6b70 <malloc+0xb7e>
...
void forkfork(char *s) {
    ...
    1ce8:	e9c50513          	addi	a0,a0,-356 # 6b80 <malloc+0xb8e>
...
void reparent2(char *s) {
  ...
  exit(0);
    ...
    1d36:	08650513          	addi	a0,a0,134 # 6db8 <malloc+0xdc6>
...
void createdelete(char *s) {
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd4:	fe850513          	addi	a0,a0,-24 # 6db8 <malloc+0xdc6>
    ...
    1e00:	c4c50513          	addi	a0,a0,-948 # 6a48 <malloc+0xa56>
    ...
    1e72:	d3250513          	addi	a0,a0,-718 # 6ba0 <malloc+0xbae>
    ...
    1ea6:	d1650513          	addi	a0,a0,-746 # 6bb8 <malloc+0xbc6>
    ...
    1f0c:	cd850513          	addi	a0,a0,-808 # 6be0 <malloc+0xbee>
...
void linkunlink(char *s) {
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1ff0:	c1cb8b93          	addi	s7,s7,-996 # 6c08 <malloc+0xc16>
    1ff4:	a825                	j	202c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ff6:	85a6                	mv	a1,s1
    1ff8:	00005517          	auipc	a0,0x5
    1ffc:	9b850513          	addi	a0,a0,-1608 # 69b0 <malloc+0x9be>
...
void forktest(char *s) {
  ...
  for (n = 0; n < N; n++) {
    ...
    20be:	b6e50513          	addi	a0,a0,-1170 # 6c28 <malloc+0xc36>
  ...
  if (wait(0) != -1) {
    ...
    2120:	af450513          	addi	a0,a0,-1292 # 6c10 <malloc+0xc1e>
    ...
    213c:	b1850513          	addi	a0,a0,-1256 # 6c50 <malloc+0xc5e>
    ...
    2158:	b1450513          	addi	a0,a0,-1260 # 6c68 <malloc+0xc76>
...
void kernmem(char *s) {
  ...
  for (a = (char *)(KERNBASE); a < (char *)(KERNBASE + 2000000); a += 50000) {
    ...
    21d8:	7dc50513          	addi	a0,a0,2012 # 69b0 <malloc+0x9be>
    ...
    21fa:	a8a50513          	addi	a0,a0,-1398 # 6c80 <malloc+0xc8e>
...
void MAXVAplus(char *s) {
  ...
  for (; a != 0; a <<= 1) {
    ...
    227c:	73850513          	addi	a0,a0,1848 # 69b0 <malloc+0x9be>
    ...
    22a8:	9fc50513          	addi	a0,a0,-1540 # 6ca0 <malloc+0xcae>
...
void bigargtest(char *s) {
  ...
  unlink("bigarg-ok");
    ...
    22d8:	9e450513          	addi	a0,a0,-1564 # 6cb8 <malloc+0xcc6>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230a:	9b250513          	addi	a0,a0,-1614 # 6cb8 <malloc+0xcc6>
  ...
  close(fd);
    ...
    2340:	98c70713          	addi	a4,a4,-1652 # 6cc8 <malloc+0xcd6>
    ...
    2370:	94c50513          	addi	a0,a0,-1716 # 6cb8 <malloc+0xcc6>
    ...
    2394:	a1850513          	addi	a0,a0,-1512 # 6da8 <malloc+0xdb6>
  ...
  if (xstatus != 0) exit(xstatus);
    ...
    23b8:	a1450513          	addi	a0,a0,-1516 # 6dc8 <malloc+0xdd6>
...
static inline uint64 r_sp() {
  ...
  asm volatile("mv %0, sp" : "=r"(x));
    ...
    2416:	9d650513          	addi	a0,a0,-1578 # 6de8 <malloc+0xdf6>
    ...
    2432:	58250513          	addi	a0,a0,1410 # 69b0 <malloc+0x9be>
...
void textwrite(char *s) {
  ...
  if (xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a0:	51450513          	addi	a0,a0,1300 # 69b0 <malloc+0x9be>
...
void manywrites(char *s) {
  ...
  exit(0);
    ...
    251c:	8a050513          	addi	a0,a0,-1888 # 6db8 <malloc+0xdc6>
    ...
    25cc:	84850513          	addi	a0,a0,-1976 # 6e10 <malloc+0xe1e>
...
void copyinstr3(char *s) {
  ...
  *b = 'x';
  ...
  char *args[] = {"xx", 0};
    ...
    2684:	48878793          	addi	a5,a5,1160 # 7b08 <malloc+0x1b16>
  ...
  if (ret != -1) {
    ...
    26c6:	76650513          	addi	a0,a0,1894 # 6e28 <malloc+0xe36>
    ...
    26e4:	1f050513          	addi	a0,a0,496 # 68d0 <malloc+0x8de>
    ...
    2702:	1f250513          	addi	a0,a0,498 # 68f0 <malloc+0x8fe>
    ...
    2722:	1f250513          	addi	a0,a0,498 # 6910 <malloc+0x91e>
    ...
    2740:	1fc50513          	addi	a0,a0,508 # 6938 <malloc+0x946>
...
void rwsbrk() {
  ...
  fd = open("rwsbrk", O_CREATE | O_WRONLY);
    ...
    278c:	6e050513          	addi	a0,a0,1760 # 6e68 <malloc+0xe76>
  ...
  if (n >= 0) {
    ...
    27bc:	6d050513          	addi	a0,a0,1744 # 6e88 <malloc+0xe96>
    ...
    27d6:	65e50513          	addi	a0,a0,1630 # 6e30 <malloc+0xe3e>
    ...
    27f0:	65c50513          	addi	a0,a0,1628 # 6e48 <malloc+0xe56>
    ...
    280a:	66a50513          	addi	a0,a0,1642 # 6e70 <malloc+0xe7e>
  ...
  unlink("rwsbrk");
    ...
    282e:	63e50513          	addi	a0,a0,1598 # 6e68 <malloc+0xe76>
  ...
  if (n >= 0) {
    ...
    286a:	65250513          	addi	a0,a0,1618 # 6eb8 <malloc+0xec6>
    ...
    2884:	5f050513          	addi	a0,a0,1520 # 6e70 <malloc+0xe7e>
...
void sbrkbasic(char *s) {
  ...
  if (pid == 0) {
    ...
    2904:	5e050513          	addi	a0,a0,1504 # 6ee0 <malloc+0xeee>
  ...
  for (i = 0; i < 5000; i++) {
    ...
    2956:	5ae50513          	addi	a0,a0,1454 # 6f00 <malloc+0xf0e>
  ...
  if (c != a + 1) {
    ...
    29ba:	5aa50513          	addi	a0,a0,1450 # 6f60 <malloc+0xf6e>
    ...
    29dc:	54850513          	addi	a0,a0,1352 # 6f20 <malloc+0xf2e>
    ...
    29f8:	54c50513          	addi	a0,a0,1356 # 6f40 <malloc+0xf4e>
...
void sbrkmuch(char *s) {
  ...
  *lastaddr = 99;
  ...
  if (c != a) {
    ...
    2b42:	44250513          	addi	a0,a0,1090 # 6f80 <malloc+0xf8e>
    ...
    2b5e:	46e50513          	addi	a0,a0,1134 # 6fc8 <malloc+0xfd6>
    ...
    2b7e:	46e50513          	addi	a0,a0,1134 # 6fe8 <malloc+0xff6>
    ...
    2b9e:	48e50513          	addi	a0,a0,1166 # 7028 <malloc+0x1036>
    ...
    2bba:	4a250513          	addi	a0,a0,1186 # 7058 <malloc+0x1066>
    ...
    2bda:	4ba50513          	addi	a0,a0,1210 # 7090 <malloc+0x109e>
...
void sbrkarg(char *s) {
  ...
  fd = open("sbrk", O_CREATE | O_WRONLY);
    ...
    2c14:	4a850513          	addi	a0,a0,1192 # 70b8 <malloc+0x10c6>
    2c18:	00003097          	auipc	ra,0x3
    2c1c:	fe8080e7          	jalr	-24(ra) # 5c00 <open>
    2c20:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c22:	00004517          	auipc	a0,0x4
    2c26:	49650513          	addi	a0,a0,1174 # 70b8 <malloc+0x10c6>
  ...
  if (pipe((int *)a) != 0) {
    ...
    2c7a:	44a50513          	addi	a0,a0,1098 # 70c0 <malloc+0x10ce>
    ...
    2c96:	44650513          	addi	a0,a0,1094 # 70d8 <malloc+0x10e6>
    ...
    2cb2:	e0a50513          	addi	a0,a0,-502 # 6ab8 <malloc+0xac6>
...
void argptest(char *s) {
  ...
  fd = open("init", O_RDONLY);
    ...
    2cdc:	41850513          	addi	a0,a0,1048 # 70f0 <malloc+0x10fe>
  ...
  close(fd);
    ...
    2d24:	ca850513          	addi	a0,a0,-856 # 69c8 <malloc+0x9d6>
...
void sbrkbugs(char *s) {
  ...
  if (pid == 0) {
    ...
    2d72:	04a50513          	addi	a0,a0,74 # 6db8 <malloc+0xdc6>
  ...
  if (pid == 0) {
    ...
    2dc8:	ff450513          	addi	a0,a0,-12 # 6db8 <malloc+0xdc6>
  ...
  if (pid == 0) {
    ...
    2e28:	f9450513          	addi	a0,a0,-108 # 6db8 <malloc+0xdc6>
...
void execout(char *s) {
  ...
  exit(0);
    ...
    2f9c:	e2050513          	addi	a0,a0,-480 # 6db8 <malloc+0xdc6>
...
void fourteen(char *s) {
  ...
  if (mkdir("12345678901234") != 0) {
    ...
    302e:	29e50513          	addi	a0,a0,670 # 72c8 <malloc+0x12d6>
  ...
  if (mkdir("12345678901234/123456789012345") != 0) {
    ...
    3040:	0e450513          	addi	a0,a0,228 # 7120 <malloc+0x112e>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    3056:	12650513          	addi	a0,a0,294 # 7178 <malloc+0x1186>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3074:	18050513          	addi	a0,a0,384 # 71f0 <malloc+0x11fe>
  ...
  if (mkdir("12345678901234/12345678901234") == 0) {
    ...
    3090:	1d450513          	addi	a0,a0,468 # 7260 <malloc+0x126e>
  ...
  if (mkdir("123456789012345/12345678901234") == 0) {
    ...
    30a2:	21a50513          	addi	a0,a0,538 # 72b8 <malloc+0x12c6>
  ...
  unlink("12345678901234");
    ...
    3120:	fdc50513          	addi	a0,a0,-36 # 70f8 <malloc+0x1106>
    ...
    313c:	00850513          	addi	a0,a0,8 # 7140 <malloc+0x114e>
    ...
    3158:	05450513          	addi	a0,a0,84 # 71a8 <malloc+0x11b6>
    ...
    3174:	0b050513          	addi	a0,a0,176 # 7220 <malloc+0x122e>
    ...
    3190:	0f450513          	addi	a0,a0,244 # 7280 <malloc+0x128e>
    ...
    31ac:	13050513          	addi	a0,a0,304 # 72d8 <malloc+0x12e6>
...
void diskfull(char *s) {
  ...
  unlink("diskfulldir");
    ...
    31f8:	11c50513          	addi	a0,a0,284 # 7310 <malloc+0x131e>
  ...
  for (fi = 0; done == 0; fi++) {
    ...
    3222:	10250513          	addi	a0,a0,258 # 7320 <malloc+0x132e>
  ...
  if (mkdir("diskfulldir") == 0)
    ...
    32b2:	06250513          	addi	a0,a0,98 # 7310 <malloc+0x131e>
  ...
  unlink("diskfulldir");
    ...
    32c6:	04e50513          	addi	a0,a0,78 # 7310 <malloc+0x131e>
  ...
  for (fi = 0; done == 0; fi++) {
    ...
    33f4:	f5050513          	addi	a0,a0,-176 # 7340 <malloc+0x134e>
...
void iputtest(char *s) {
  ...
  if (mkdir("iputdir") < 0) {
    ...
    3412:	f6250513          	addi	a0,a0,-158 # 7370 <malloc+0x137e>
  ...
  if (chdir("iputdir") < 0) {
    ...
    3426:	f4e50513          	addi	a0,a0,-178 # 7370 <malloc+0x137e>
  ...
  if (unlink("../iputdir") < 0) {
    ...
    343a:	f7a50513          	addi	a0,a0,-134 # 73b0 <malloc+0x13be>
  ...
  if (chdir("/") < 0) {
    ...
    344e:	f9650513          	addi	a0,a0,-106 # 73e0 <malloc+0x13ee>
    ...
    346e:	f0e50513          	addi	a0,a0,-242 # 7378 <malloc+0x1386>
    ...
    348a:	f0a50513          	addi	a0,a0,-246 # 7390 <malloc+0x139e>
    ...
    34a6:	f1e50513          	addi	a0,a0,-226 # 73c0 <malloc+0x13ce>
    ...
    34c2:	f2a50513          	addi	a0,a0,-214 # 73e8 <malloc+0x13f6>
...
void exitiputtest(char *s) {
  ...
  if (pid == 0) {
    ...
    34f6:	e7e50513          	addi	a0,a0,-386 # 7370 <malloc+0x137e>
    ...
    350a:	e6a50513          	addi	a0,a0,-406 # 7370 <malloc+0x137e>
    ...
    351e:	e9650513          	addi	a0,a0,-362 # 73b0 <malloc+0x13be>
    ...
    353e:	47650513          	addi	a0,a0,1142 # 69b0 <malloc+0x9be>
    ...
    355a:	e2250513          	addi	a0,a0,-478 # 7378 <malloc+0x1386>
    ...
    3576:	e8e50513          	addi	a0,a0,-370 # 7400 <malloc+0x140e>
    ...
    3592:	e3250513          	addi	a0,a0,-462 # 73c0 <malloc+0x13ce>
...
void dirtest(char *s) {
  ...
  if (mkdir("dir0") < 0) {
    ...
    35d0:	e4c50513          	addi	a0,a0,-436 # 7418 <malloc+0x1426>
  ...
  if (chdir("dir0") < 0) {
    ...
    35e4:	e3850513          	addi	a0,a0,-456 # 7418 <malloc+0x1426>
  ...
  if (chdir("..") < 0) {
    ...
    35f8:	e4450513          	addi	a0,a0,-444 # 7438 <malloc+0x1446>
  ...
  if (unlink("dir0") < 0) {
    ...
    360c:	e1050513          	addi	a0,a0,-496 # 7418 <malloc+0x1426>
    ...
    362c:	d5050513          	addi	a0,a0,-688 # 7378 <malloc+0x1386>
    ...
    3648:	ddc50513          	addi	a0,a0,-548 # 7420 <malloc+0x142e>
    ...
    3664:	de050513          	addi	a0,a0,-544 # 7440 <malloc+0x144e>
    ...
    3680:	ddc50513          	addi	a0,a0,-548 # 7458 <malloc+0x1466>
...
void subdir(char *s) {
  ...
  unlink("ff");
    ...
    36a8:	efc50513          	addi	a0,a0,-260 # 75a0 <malloc+0x15ae>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	564080e7          	jalr	1380(ra) # 5c10 <unlink>
  if (mkdir("dd") != 0) {
    36b4:	00004517          	auipc	a0,0x4
    36b8:	dbc50513          	addi	a0,a0,-580 # 7470 <malloc+0x147e>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d0:	dc450513          	addi	a0,a0,-572 # 7490 <malloc+0x149e>
  ...
  write(fd, "ff", 2);
    ...
    36e8:	ebc58593          	addi	a1,a1,-324 # 75a0 <malloc+0x15ae>
  ...
  if (unlink("dd") >= 0) {
    ...
    3702:	d7250513          	addi	a0,a0,-654 # 7470 <malloc+0x147e>
  ...
  if (mkdir("/dd/dd") != 0) {
    ...
    3716:	dd650513          	addi	a0,a0,-554 # 74e8 <malloc+0x14f6>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    372e:	de650513          	addi	a0,a0,-538 # 7510 <malloc+0x151e>
  ...
  write(fd, "FF", 2);
    ...
    3746:	dfe58593          	addi	a1,a1,-514 # 7540 <malloc+0x154e>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3762:	dea50513          	addi	a0,a0,-534 # 7548 <malloc+0x1556>
  ...
  if (link("dd/dd/ff", "dd/dd/ffff") != 0) {
    ...
    37aa:	df258593          	addi	a1,a1,-526 # 7598 <malloc+0x15a6>
    37ae:	00004517          	auipc	a0,0x4
    37b2:	d6250513          	addi	a0,a0,-670 # 7510 <malloc+0x151e>
  ...
  if (unlink("dd/dd/ff") != 0) {
    ...
    37c6:	d4e50513          	addi	a0,a0,-690 # 7510 <malloc+0x151e>
  ...
  if (open("dd/dd/ff", O_RDONLY) >= 0) {
    ...
    37dc:	d3850513          	addi	a0,a0,-712 # 7510 <malloc+0x151e>
  ...
  if (chdir("dd") != 0) {
    ...
    37f0:	c8450513          	addi	a0,a0,-892 # 7470 <malloc+0x147e>
  ...
  if (chdir("dd/../../dd") != 0) {
    ...
    3804:	e3050513          	addi	a0,a0,-464 # 7630 <malloc+0x163e>
  ...
  if (chdir("dd/../../../dd") != 0) {
    ...
    3818:	e4c50513          	addi	a0,a0,-436 # 7660 <malloc+0x166e>
  ...
  if (chdir("./..") != 0) {
    ...
    382c:	e6850513          	addi	a0,a0,-408 # 7690 <malloc+0x169e>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3842:	d5a50513          	addi	a0,a0,-678 # 7598 <malloc+0x15a6>
  ...
  if (open("dd/dd/ff", O_RDONLY) >= 0) {
    ...
    387c:	c9850513          	addi	a0,a0,-872 # 7510 <malloc+0x151e>
  ...
  if (open("dd/ff/ff", O_CREATE | O_RDWR) >= 0) {
    ...
    3894:	e9050513          	addi	a0,a0,-368 # 7720 <malloc+0x172e>
  ...
  if (open("dd/xx/ff", O_CREATE | O_RDWR) >= 0) {
    ...
    38ac:	ea850513          	addi	a0,a0,-344 # 7750 <malloc+0x175e>
  ...
  if (open("dd", O_CREATE) >= 0) {
    ...
    38c4:	bb050513          	addi	a0,a0,-1104 # 7470 <malloc+0x147e>
  ...
  if (open("dd", O_RDWR) >= 0) {
    ...
    38da:	b9a50513          	addi	a0,a0,-1126 # 7470 <malloc+0x147e>
  ...
  if (open("dd", O_WRONLY) >= 0) {
    ...
    38f0:	b8450513          	addi	a0,a0,-1148 # 7470 <malloc+0x147e>
  ...
  if (link("dd/ff/ff", "dd/dd/xx") == 0) {
    ...
    3904:	ee058593          	addi	a1,a1,-288 # 77e0 <malloc+0x17ee>
    3908:	00004517          	auipc	a0,0x4
    390c:	e1850513          	addi	a0,a0,-488 # 7720 <malloc+0x172e>
  ...
  if (link("dd/xx/ff", "dd/dd/xx") == 0) {
    ...
    3920:	ec458593          	addi	a1,a1,-316 # 77e0 <malloc+0x17ee>
    3924:	00004517          	auipc	a0,0x4
    3928:	e2c50513          	addi	a0,a0,-468 # 7750 <malloc+0x175e>
  ...
  if (link("dd/ff", "dd/dd/ffff") == 0) {
    ...
    393c:	c6058593          	addi	a1,a1,-928 # 7598 <malloc+0x15a6>
    3940:	00004517          	auipc	a0,0x4
    3944:	b5050513          	addi	a0,a0,-1200 # 7490 <malloc+0x149e>
  ...
  if (mkdir("dd/ff/ff") == 0) {
    ...
    3958:	dcc50513          	addi	a0,a0,-564 # 7720 <malloc+0x172e>
  ...
  if (mkdir("dd/xx/ff") == 0) {
    ...
    396c:	de850513          	addi	a0,a0,-536 # 7750 <malloc+0x175e>
  ...
  if (mkdir("dd/dd/ffff") == 0) {
    ...
    3980:	c1c50513          	addi	a0,a0,-996 # 7598 <malloc+0x15a6>
  ...
  if (unlink("dd/xx/ff") == 0) {
    ...
    3994:	dc050513          	addi	a0,a0,-576 # 7750 <malloc+0x175e>
  ...
  if (unlink("dd/ff/ff") == 0) {
    ...
    39a8:	d7c50513          	addi	a0,a0,-644 # 7720 <malloc+0x172e>
  ...
  if (chdir("dd/ff") == 0) {
    ...
    39bc:	ad850513          	addi	a0,a0,-1320 # 7490 <malloc+0x149e>
  ...
  if (chdir("dd/xx") == 0) {
    ...
    39d0:	f6450513          	addi	a0,a0,-156 # 7930 <malloc+0x193e>
  ...
  if (unlink("dd/dd/ffff") != 0) {
    ...
    39e4:	bb850513          	addi	a0,a0,-1096 # 7598 <malloc+0x15a6>
  ...
  if (unlink("dd/ff") != 0) {
    ...
    39f8:	a9c50513          	addi	a0,a0,-1380 # 7490 <malloc+0x149e>
  ...
  if (unlink("dd") == 0) {
    ...
    3a0c:	a6850513          	addi	a0,a0,-1432 # 7470 <malloc+0x147e>
  ...
  if (unlink("dd/dd") < 0) {
    ...
    3a20:	f8450513          	addi	a0,a0,-124 # 79a0 <malloc+0x19ae>
  ...
  if (unlink("dd") < 0) {
    ...
    3a34:	a4050513          	addi	a0,a0,-1472 # 7470 <malloc+0x147e>
    ...
    3a56:	a2650513          	addi	a0,a0,-1498 # 7478 <malloc+0x1486>
    ...
    3a72:	a2a50513          	addi	a0,a0,-1494 # 7498 <malloc+0x14a6>
    ...
    3a8e:	a2e50513          	addi	a0,a0,-1490 # 74b8 <malloc+0x14c6>
    ...
    3aaa:	a4a50513          	addi	a0,a0,-1462 # 74f0 <malloc+0x14fe>
    ...
    3ac6:	a5e50513          	addi	a0,a0,-1442 # 7520 <malloc+0x152e>
    ...
    3ae2:	a7a50513          	addi	a0,a0,-1414 # 7558 <malloc+0x1566>
    ...
    3afe:	a7e50513          	addi	a0,a0,-1410 # 7578 <malloc+0x1586>
    ...
    3b1a:	a9250513          	addi	a0,a0,-1390 # 75a8 <malloc+0x15b6>
    ...
    3b36:	a9e50513          	addi	a0,a0,-1378 # 75d0 <malloc+0x15de>
    ...
    3b52:	aa250513          	addi	a0,a0,-1374 # 75f0 <malloc+0x15fe>
    ...
    3b6e:	aae50513          	addi	a0,a0,-1362 # 7618 <malloc+0x1626>
    ...
    3b8a:	aba50513          	addi	a0,a0,-1350 # 7640 <malloc+0x164e>
    ...
    3ba6:	ace50513          	addi	a0,a0,-1330 # 7670 <malloc+0x167e>
    ...
    3bc2:	ada50513          	addi	a0,a0,-1318 # 7698 <malloc+0x16a6>
    ...
    3bde:	ad650513          	addi	a0,a0,-1322 # 76b0 <malloc+0x16be>
    ...
    3bfa:	ada50513          	addi	a0,a0,-1318 # 76d0 <malloc+0x16de>
    ...
    3c16:	ade50513          	addi	a0,a0,-1314 # 76f0 <malloc+0x16fe>
    ...
    3c32:	b0250513          	addi	a0,a0,-1278 # 7730 <malloc+0x173e>
    ...
    3c4e:	b1650513          	addi	a0,a0,-1258 # 7760 <malloc+0x176e>
    ...
    3c6a:	b1a50513          	addi	a0,a0,-1254 # 7780 <malloc+0x178e>
    ...
    3c86:	b1e50513          	addi	a0,a0,-1250 # 77a0 <malloc+0x17ae>
    ...
    3ca2:	b2250513          	addi	a0,a0,-1246 # 77c0 <malloc+0x17ce>
    ...
    3cbe:	b3650513          	addi	a0,a0,-1226 # 77f0 <malloc+0x17fe>
    ...
    3cda:	b4250513          	addi	a0,a0,-1214 # 7818 <malloc+0x1826>
    ...
    3cf6:	b4e50513          	addi	a0,a0,-1202 # 7840 <malloc+0x184e>
    ...
    3d12:	b5a50513          	addi	a0,a0,-1190 # 7868 <malloc+0x1876>
    ...
    3d2e:	b5e50513          	addi	a0,a0,-1186 # 7888 <malloc+0x1896>
    ...
    3d4a:	b6250513          	addi	a0,a0,-1182 # 78a8 <malloc+0x18b6>
    ...
    3d66:	b6e50513          	addi	a0,a0,-1170 # 78d0 <malloc+0x18de>
    ...
    3d82:	b7250513          	addi	a0,a0,-1166 # 78f0 <malloc+0x18fe>
    ...
    3d9e:	b7650513          	addi	a0,a0,-1162 # 7910 <malloc+0x191e>
    ...
    3dba:	b8250513          	addi	a0,a0,-1150 # 7938 <malloc+0x1946>
    ...
    3dd6:	7fe50513          	addi	a0,a0,2046 # 75d0 <malloc+0x15de>
    ...
    3df2:	b6a50513          	addi	a0,a0,-1174 # 7958 <malloc+0x1966>
    ...
    3e0e:	b6e50513          	addi	a0,a0,-1170 # 7978 <malloc+0x1986>
    ...
    3e2a:	b8250513          	addi	a0,a0,-1150 # 79a8 <malloc+0x19b6>
    ...
    3e46:	b8650513          	addi	a0,a0,-1146 # 79c8 <malloc+0x19d6>
...
void rmdot(char *s) {
  ...
  if (mkdir("dots") != 0) {
    ...
    3e6c:	b7850513          	addi	a0,a0,-1160 # 79e0 <malloc+0x19ee>
  ...
  if (chdir("dots") != 0) {
    ...
    3e7e:	b6650513          	addi	a0,a0,-1178 # 79e0 <malloc+0x19ee>
  ...
  if (unlink(".") == 0) {
    ...
    3e90:	98450513          	addi	a0,a0,-1660 # 6810 <malloc+0x81e>
  ...
  if (unlink("..") == 0) {
    ...
    3ea2:	59a50513          	addi	a0,a0,1434 # 7438 <malloc+0x1446>
  ...
  if (chdir("/") != 0) {
    ...
    3eb4:	53050513          	addi	a0,a0,1328 # 73e0 <malloc+0x13ee>
  ...
  if (unlink("dots/.") == 0) {
    ...
    3ec6:	b8650513          	addi	a0,a0,-1146 # 7a48 <malloc+0x1a56>
  ...
  if (unlink("dots/..") == 0) {
    ...
    3ed8:	b9c50513          	addi	a0,a0,-1124 # 7a70 <malloc+0x1a7e>
  ...
  if (unlink("dots") != 0) {
    ...
    3eea:	afa50513          	addi	a0,a0,-1286 # 79e0 <malloc+0x19ee>
    ...
    3f08:	ae450513          	addi	a0,a0,-1308 # 79e8 <malloc+0x19f6>
    ...
    3f24:	ae050513          	addi	a0,a0,-1312 # 7a00 <malloc+0x1a0e>
    ...
    3f40:	adc50513          	addi	a0,a0,-1316 # 7a18 <malloc+0x1a26>
    ...
    3f5c:	ad850513          	addi	a0,a0,-1320 # 7a30 <malloc+0x1a3e>
    ...
    3f78:	47450513          	addi	a0,a0,1140 # 73e8 <malloc+0x13f6>
    ...
    3f94:	ac050513          	addi	a0,a0,-1344 # 7a50 <malloc+0x1a5e>
    ...
    3fb0:	acc50513          	addi	a0,a0,-1332 # 7a78 <malloc+0x1a86>
    ...
    3fcc:	ad050513          	addi	a0,a0,-1328 # 7a98 <malloc+0x1aa6>
...
void dirfile(char *s) {
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ff8:	ac450513          	addi	a0,a0,-1340 # 7ab8 <malloc+0x1ac6>
  ...
  if (chdir("dirfile") == 0) {
    ...
    4014:	aa850513          	addi	a0,a0,-1368 # 7ab8 <malloc+0x1ac6>
  ...
  fd = open("dirfile/xx", 0);
    ...
    4028:	adc50513          	addi	a0,a0,-1316 # 7b00 <malloc+0x1b0e>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4040:	ac450513          	addi	a0,a0,-1340 # 7b00 <malloc+0x1b0e>
  ...
  if (mkdir("dirfile/xx") == 0) {
    ...
    4054:	ab050513          	addi	a0,a0,-1360 # 7b00 <malloc+0x1b0e>
  ...
  if (unlink("dirfile/xx") == 0) {
    ...
    4068:	a9c50513          	addi	a0,a0,-1380 # 7b00 <malloc+0x1b0e>
  ...
  if (link("xv6-readme", "dirfile/xx") == 0) {
    ...
    407c:	a8858593          	addi	a1,a1,-1400 # 7b00 <malloc+0x1b0e>
  ...
  if (unlink("dirfile") != 0) {
    ...
    4098:	a2450513          	addi	a0,a0,-1500 # 7ab8 <malloc+0x1ac6>
  ...
  fd = open(".", O_RDWR);
    ...
    40ae:	76650513          	addi	a0,a0,1894 # 6810 <malloc+0x81e>
  ...
  fd = open(".", 0);
    ...
    40c4:	75050513          	addi	a0,a0,1872 # 6810 <malloc+0x81e>
  ...
  close(fd);
    ...
    4104:	9c050513          	addi	a0,a0,-1600 # 7ac0 <malloc+0x1ace>
    ...
    4120:	9c450513          	addi	a0,a0,-1596 # 7ae0 <malloc+0x1aee>
    ...
    413c:	9d850513          	addi	a0,a0,-1576 # 7b10 <malloc+0x1b1e>
    ...
    4158:	9bc50513          	addi	a0,a0,-1604 # 7b10 <malloc+0x1b1e>
    ...
    4174:	9c850513          	addi	a0,a0,-1592 # 7b38 <malloc+0x1b46>
    ...
    4190:	9d450513          	addi	a0,a0,-1580 # 7b60 <malloc+0x1b6e>
    ...
    41ac:	9e050513          	addi	a0,a0,-1568 # 7b88 <malloc+0x1b96>
    ...
    41c8:	9ec50513          	addi	a0,a0,-1556 # 7bb0 <malloc+0x1bbe>
    ...
    41e4:	9f050513          	addi	a0,a0,-1552 # 7bd0 <malloc+0x1bde>
    ...
    4200:	9fc50513          	addi	a0,a0,-1540 # 7bf8 <malloc+0x1c06>
...
void iref(char *s) {
    ...
    4234:	9e0a0a13          	addi	s4,s4,-1568 # 7c10 <malloc+0x1c1e>
    mkdir("");
    4238:	00003497          	auipc	s1,0x3
    423c:	4e048493          	addi	s1,s1,1248 # 7718 <malloc+0x1726>
    link("xv6-readme", "");
    4240:	00002a97          	auipc	s5,0x2
    4244:	0b0a8a93          	addi	s5,s5,176 # 62f0 <malloc+0x2fe>
    fd = open("xx", O_CREATE);
    4248:	00004997          	auipc	s3,0x4
    424c:	8c098993          	addi	s3,s3,-1856 # 7b08 <malloc+0x1b16>
    4250:	a891                	j	42a4 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4252:	85da                	mv	a1,s6
    4254:	00004517          	auipc	a0,0x4
    4258:	9c450513          	addi	a0,a0,-1596 # 7c18 <malloc+0x1c26>
    ...
    4274:	9c050513          	addi	a0,a0,-1600 # 7c30 <malloc+0x1c3e>
  ...
  for (i = 0; i < NINODE + 1; i++) {
    ...
    4308:	13498993          	addi	s3,s3,308 # 7438 <malloc+0x1446>
    unlink("irefd");
    430c:	00004917          	auipc	s2,0x4
    4310:	90490913          	addi	s2,s2,-1788 # 7c10 <malloc+0x1c1e>
    chdir("..");
    4314:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4330:	0b450513          	addi	a0,a0,180 # 73e0 <malloc+0x13ee>
...
void openiputtest(char *s) {
  ...
  if (mkdir("oidir") < 0) {
    ...
    4360:	8ec50513          	addi	a0,a0,-1812 # 7c48 <malloc+0x1c56>
  ...
  if (pid == 0) {
    ...
    4384:	8c850513          	addi	a0,a0,-1848 # 7c48 <malloc+0x1c56>
    ...
    439a:	8d250513          	addi	a0,a0,-1838 # 7c68 <malloc+0x1c76>
    ...
    43b6:	89e50513          	addi	a0,a0,-1890 # 7c50 <malloc+0x1c5e>
    ...
    43d2:	5e250513          	addi	a0,a0,1506 # 69b0 <malloc+0x9be>
  ...
  if (unlink("oidir") != 0) {
    ...
    4400:	84c50513          	addi	a0,a0,-1972 # 7c48 <malloc+0x1c56>
    ...
    4414:	79050513          	addi	a0,a0,1936 # 6ba0 <malloc+0xbae>
...
void forkforkfork(char *s) {
  ...
  unlink("stopforking");
    ...
    4452:	84250513          	addi	a0,a0,-1982 # 7c90 <malloc+0x1c9e>
  ...
  close(open("stopforking", O_CREATE | O_RDWR));
    ...
    447e:	81650513          	addi	a0,a0,-2026 # 7c90 <malloc+0x1c9e>
  ...
  sleep(10);  // one second
    ...
    44b6:	6be50513          	addi	a0,a0,1726 # 6b70 <malloc+0xb7e>
    ...
    44d0:	7c448493          	addi	s1,s1,1988 # 7c90 <malloc+0x1c9e>
    44d4:	4581                	li	a1,0
    44d6:	8526                	mv	a0,s1
...
void killstatus(char *s) {
  ...
  exit(0);
    ...
    4578:	43c50513          	addi	a0,a0,1084 # 69b0 <malloc+0x9be>
    ...
    459e:	70650513          	addi	a0,a0,1798 # 7ca0 <malloc+0x1cae>
...
void preempt(char *s) {
  ...
  if (pid1 == 0)
    ...
    45de:	59650513          	addi	a0,a0,1430 # 6b70 <malloc+0xb7e>
  ...
  if (pid2 == 0)
    ...
    460c:	3a850513          	addi	a0,a0,936 # 69b0 <malloc+0x9be>
  ...
  if (pid3 == 0) {
    ...
    467a:	33a50513          	addi	a0,a0,826 # 69b0 <malloc+0x9be>
    ...
    4696:	62e50513          	addi	a0,a0,1582 # 7cc0 <malloc+0x1cce>
  ...
  if (read(pfds[0], buf, sizeof(buf)) != 1) {
    ...
    46d2:	60a50513          	addi	a0,a0,1546 # 7cd8 <malloc+0x1ce6>
  ...
  printf("kill... ");
    ...
    46fe:	5f650513          	addi	a0,a0,1526 # 7cf0 <malloc+0x1cfe>
  ...
  printf("wait... ");
    ...
    472c:	5d850513          	addi	a0,a0,1496 # 7d00 <malloc+0x1d0e>
...
void reparent(char *s) {
  ...
  exit(0);
    ...
    47ac:	20850513          	addi	a0,a0,520 # 69b0 <malloc+0x9be>
    ...
    47c8:	37450513          	addi	a0,a0,884 # 6b38 <malloc+0xb46>
...
void sbrkfail(char *s) {
  ...
  if (pipe(fds) != 0) {
    ...
    483e:	27e50513          	addi	a0,a0,638 # 6ab8 <malloc+0xac6>
  ...
  if (xstatus != -1 && xstatus != 2) exit(1);
    ...
    4936:	3de50513          	addi	a0,a0,990 # 7d10 <malloc+0x1d1e>
    ...
    4952:	06250513          	addi	a0,a0,98 # 69b0 <malloc+0x9be>
    ...
    499e:	39650513          	addi	a0,a0,918 # 7d30 <malloc+0x1d3e>
...
void mem(char *s) {
  ...
  if ((pid = fork()) == 0) {
    ...
    4a42:	32250513          	addi	a0,a0,802 # 7d60 <malloc+0x1d6e>
...
void sharedfd(char *s) {
  ...
  if (pid == 0) {
    ...
    4af8:	29c50513          	addi	a0,a0,668 # 7d90 <malloc+0x1d9e>
    ...
    4b14:	2a850513          	addi	a0,a0,680 # 7db8 <malloc+0x1dc6>
  ...
  fd = open("sharedfd", 0);
    ...
    4b58:	22c50513          	addi	a0,a0,556 # 7d80 <malloc+0x1d8e>
  ...
  while ((n = read(fd, buf, sizeof(buf))) > 0) {
    ...
    4b98:	24450513          	addi	a0,a0,580 # 7dd8 <malloc+0x1de6>
  ...
  unlink("sharedfd");
    ...
    4bd4:	1b050513          	addi	a0,a0,432 # 7d80 <malloc+0x1d8e>
  ...
  if (nc == N * SZ && np == N * SZ) {
    ...
    4bfa:	20a50513          	addi	a0,a0,522 # 7e00 <malloc+0x1e0e>
...
void fourfiles(char *s) {
  ...
  char *names[] = {"f0", "f1", "f2", "f3"};
    ...
    4c40:	1dc78793          	addi	a5,a5,476 # 7e18 <malloc+0x1e26>
    4c44:	f6f43823          	sd	a5,-144(s0)
    4c48:	00003797          	auipc	a5,0x3
    4c4c:	1d878793          	addi	a5,a5,472 # 7e20 <malloc+0x1e2e>
    4c50:	f6f43c23          	sd	a5,-136(s0)
    4c54:	00003797          	auipc	a5,0x3
    4c58:	1d478793          	addi	a5,a5,468 # 7e28 <malloc+0x1e36>
    4c5c:	f8f43023          	sd	a5,-128(s0)
    4c60:	00003797          	auipc	a5,0x3
    4c64:	1d078793          	addi	a5,a5,464 # 7e30 <malloc+0x1e3e>
  ...
  for (i = 0; i < NCHILD; i++) {
    ...
    4cdc:	0e050513          	addi	a0,a0,224 # 6db8 <malloc+0xdc6>
    ...
    4d58:	0e450513          	addi	a0,a0,228 # 7e38 <malloc+0x1e46>
    ...
    4d72:	0da50513          	addi	a0,a0,218 # 7e48 <malloc+0x1e56>
    ...
    4d9a:	0ca50513          	addi	a0,a0,202 # 7e60 <malloc+0x1e6e>
  ...
  for (i = 0; i < NCHILD; i++) {
    ...
    4e28:	04c50513          	addi	a0,a0,76 # 7e70 <malloc+0x1e7e>
...
void concreate(char *s) {
  ...
  for (i = 0; i < N; i++) {
    ...
    4e8a:	002b8b93          	addi	s7,s7,2 # 7e88 <malloc+0x1e96>
  for (i = 0; i < N; i++) {
    ...
    4ecc:	fc850513          	addi	a0,a0,-56 # 7e90 <malloc+0x1e9e>
    ...
    4eea:	fa250513          	addi	a0,a0,-94 # 7e88 <malloc+0x1e96>
  ...
  fd = open(".", 0);
    ...
    4f22:	8f250513          	addi	a0,a0,-1806 # 6810 <malloc+0x81e>
  ...
  while (read(fd, &de, sizeof(de)) > 0) {
    ...
    4f9a:	f1a50513          	addi	a0,a0,-230 # 7eb0 <malloc+0x1ebe>
    ...
    4fba:	f1a50513          	addi	a0,a0,-230 # 7ed0 <malloc+0x1ede>
  ...
  for (i = 0; i < N; i++) {
    ...
    4ff2:	f0a50513          	addi	a0,a0,-246 # 7ef8 <malloc+0x1f06>
    ...
    500e:	9a650513          	addi	a0,a0,-1626 # 69b0 <malloc+0x9be>
...
void bigfile(char *s) {
  ...
  fd = open("bigfile.dat", 0);
    ...
    5240:	cf450513          	addi	a0,a0,-780 # 7f30 <malloc+0x1f3e>
  ...
  for (i = 0;; i++) {
    ...
    52a4:	ca050513          	addi	a0,a0,-864 # 7f40 <malloc+0x1f4e>
    ...
    52c0:	ca450513          	addi	a0,a0,-860 # 7f60 <malloc+0x1f6e>
    ...
    52dc:	ca850513          	addi	a0,a0,-856 # 7f80 <malloc+0x1f8e>
    ...
    52f8:	cac50513          	addi	a0,a0,-852 # 7fa0 <malloc+0x1fae>
    ...
    5314:	cb050513          	addi	a0,a0,-848 # 7fc0 <malloc+0x1fce>
    ...
    5330:	cac50513          	addi	a0,a0,-852 # 7fd8 <malloc+0x1fe6>
  ...
  unlink("bigfile.dat");
    ...
    535e:	bd650513          	addi	a0,a0,-1066 # 7f30 <malloc+0x1f3e>
    ...
    5382:	c7a50513          	addi	a0,a0,-902 # 7ff8 <malloc+0x2006>
...
void fsfull() {
  ...
  printf("fsfull test\n");
    ...
    53ba:	c6250513          	addi	a0,a0,-926 # 8018 <malloc+0x2026>
  ...
  for (nfiles = 0;; nfiles++) {
    ...
    53da:	c52c8c93          	addi	s9,s9,-942 # 8028 <malloc+0x2036>
    int total = 0;
    53de:	4d81                	li	s11,0
    ...
    5454:	be850513          	addi	a0,a0,-1048 # 8038 <malloc+0x2046>
  ...
  printf("fsfull test finished\n");
    ...
    54ca:	b9250513          	addi	a0,a0,-1134 # 8058 <malloc+0x2066>
    ...
    551a:	b3250513          	addi	a0,a0,-1230 # 8048 <malloc+0x2056>
...
int run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    554c:	b2850513          	addi	a0,a0,-1240 # 8070 <malloc+0x207e>
  ...
  if (pid == 0) {
    ...
    557c:	b2050513          	addi	a0,a0,-1248 # 8098 <malloc+0x20a6>
    ...
    55a0:	ae450513          	addi	a0,a0,-1308 # 8080 <malloc+0x208e>
    ...
    55c8:	adc50513          	addi	a0,a0,-1316 # 80a0 <malloc+0x20ae>
...
int runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    5618:	a9450513          	addi	a0,a0,-1388 # 80a8 <malloc+0x20b6>
...
int countfree() {
  ...
  if (pid == 0) {
    ...
    56a4:	a6050513          	addi	a0,a0,-1440 # 8100 <malloc+0x210e>
    ...
    56be:	a0650513          	addi	a0,a0,-1530 # 80c0 <malloc+0x20ce>
    ...
    56d8:	a0c50513          	addi	a0,a0,-1524 # 80e0 <malloc+0x20ee>
  ...
  while (1) {
    ...
    5726:	9fe50513          	addi	a0,a0,-1538 # 8120 <malloc+0x212e>
...
int drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    5788:	9bcb8b93          	addi	s7,s7,-1604 # 8140 <malloc+0x214e>
    int free0 = countfree();
    int free1 = 0;
    ...
    579a:	9e2c8c93          	addi	s9,s9,-1566 # 8178 <malloc+0x2186>
    ...
    57aa:	9b2d0d13          	addi	s10,s10,-1614 # 8158 <malloc+0x2166>
...
int main(int argc, char *argv[]) {
  ...
  if (argc == 2 && strcmp(argv[1], "-q") == 0) {
    ...
    589e:	90e58593          	addi	a1,a1,-1778 # 81a8 <malloc+0x21b6>
    ...
    58b6:	94e58593          	addi	a1,a1,-1714 # 8200 <malloc+0x220e>
    ...
    58cc:	93058593          	addi	a1,a1,-1744 # 81f8 <malloc+0x2206>
  ...
  int continuous = 0;
    ...
    58f8:	8bc50513          	addi	a0,a0,-1860 # 81b0 <malloc+0x21be>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5924:	8c050513          	addi	a0,a0,-1856 # 81e0 <malloc+0x21ee>
...
static void printint(int fd, int xx, int base, int sgn) {
  ...
  do {
    ...
    5ca8:	92450513          	addi	a0,a0,-1756 # 85c8 <digits>
    5cac:	883a                	mv	a6,a4
...
void vprintf(int fd, const char *fmt, va_list ap) {
  ...
  state = 0;
    ...
    5d68:	80cc8c93          	addi	s9,s9,-2036 # 8570 <malloc+0x257e>
      } else if (c == 'p') {
  ...
  putc(fd, 'x');
    ...
    5d76:	856b8b93          	addi	s7,s7,-1962 # 85c8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5e9c:	6d098993          	addi	s3,s3,1744 # 8568 <malloc+0x2576>
        while (*s != 0) {
    5ea0:	85ee                	mv	a1,s11
